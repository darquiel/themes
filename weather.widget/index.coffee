options =
  city          : "Fremont"       # default city in case location detection fails
  region        : "USA"              # default region in case location detection fails
...
appearance =
  ...
  color         : '#d6d6d6'            # configure your colors here
  darkerColor   : 'rgba(#fff, 0.8)'
  baseFontSize  : 42                # the base font size, the size of the temperature
  showLocation  : false              # set to true to show your current location in the widget
...
style: """
  ...
  .current .temperature
    font-size  : #{appearance.baseFontSize * .7}px
    font-weight: 300
  ...
  icon-size = #{appearance.baseFontSize * 2.25}px
  ...
  .icon
    ...
    font-family: Weather
    vertical-align: top
    font-size: #{appearance.baseFontSize * 1.6}px
    max-height: icon-size
    vertical-align: middle
    text-align: center
    width: icon-size * 1.1
    max-width: icon-size * 1.1
