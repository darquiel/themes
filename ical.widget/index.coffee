...
command: "'ical.widget/icalBuddy' -ec 'F7C98D85-3671-4279-88B4-0C9C22416742,DC6F4246-383F-4339-97F5-4BBDFDD7CC3D,0765A222-A3E8-40C6-AFB4-AB97DEE2CB51,00C6DE2D-4429-401E-B286-BFC8B1546F1F,3770543B-69D3-4EBC-9AC2-685DF39AD5F1' -n -nc -iep 'title,datetime' -ps '| : |' -po 'datetime,title' -tf %H:%M -eed eventsToday 2>devnull"
